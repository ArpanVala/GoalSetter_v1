            ...
            >
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  type="button"
                  onClick={() => handleClick()}
                  className="inline-flex w-full justify-center rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white hover:shadow-lg hover:bg-red-600 sm:ml-3 sm:w-auto"
                >
                  Delete <FaTrashAlt className='inline-block ml-2 mt-1'/>
                </button>
                <button
                  type="button"
                  data-autofocus
