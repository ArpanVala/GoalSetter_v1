    ...
    <div className="max-w-[1048px] mx-auto px-4 my-5 md:my-8">
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
            ...
            <div className='bg-blue-50 px-4 py-6 rounded-lg md:border-3 border-transparent hover:border-gray-400 hover:cursor-pointer '>
                ...
                <h1 className='text-md md:text-lg font-semibold text-gray-700'>20</h1>
            </div>
            <div className='bg-blue-50 px-4 py-6 rounded-lg md:border-3 border-transparent hover:border-gray-400 hover:cursor-pointer '>
        ...
        <div className='my-5'>
            ...
            <button className='text-sm md:text-md md:text-lg  bg-blue-500 hover:bg-blue-600 text-blue-50 px-3 py-1 rounded-md'>Add New Goal</button>
            <button className='text-sm md:text-md md:text-lg md:border-2 border-transparent bg-blue-50 hover:border-gray-400 text-gray-700 px-3 py-1 rounded-md '>View all Goals</button>
            </div>
        </div>
